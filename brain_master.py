...
# Core env config
WHITELIST = set([s.strip().upper() for s in getenv("WHITELIST_TICKERS", "AAPL,MSFT,AMD,NVDA,META,TSLA,SPY,QQQ,GOOGL,CRM,MSTR,MU,HOOD,ATAI,NVO,UNH,AVGO,CRWV").split(",") if s.strip()])
